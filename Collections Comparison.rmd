...
social <- metadata[grep(collections[1], metadata$item),]
...
syllabi <- metadata[grep(collections[5], metadata$item),]
early <- metadata[grep(collections[6], metadata$item),]
cook <- metadata[grep(collections[7], metadata$item),]
build <- metadata[grep(collections[8], metadata$item),]
postcards <- metadata[grep(collections[9], metadata$item),]
ley <- metadata[grep(collections[10], metadata$item),]
klein <- metadata[grep(collections[11], metadata$item),]
life <- metadata[grep(collections[12], metadata$item),]
geology <- metadata[grep(collections[13], metadata$item),]
abolition <- metadata[grep(collections[14], metadata$item),]
coins <- metadata[grep(collections[15], metadata$item),]
justice <- metadata[grep(collections[16], metadata$item),]
history <- metadata[grep(collections[17], metadata$item),]
```
...
docs_sscholar <- tm_map(docs_sscholar, removeWords, c("the"))
...
docs_fscholar <- tm_map(docs_fscholar, removeWords, c("the"))
...
docs_klein <- tm_map(docs_klein, removeWords, c("the"))
...
docs_build <- tm_map(docs_build, removeWords, c("the"))
...
docs_justice <- tm_map(docs_justice, removeWords, c(" the"))
